...
<html>
    ...
    <div class="homepage" id="homepage_div_id" style="display:block">
            ...
            <div class = "cart_div" id="cart_div_id" style="display:none">
                <!-- shop-cart-area -->
                <div class="shop-cart-area wishlist-area pt-100 pb-100">
                    <div class="container">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <h4><a href="shop-details.html">Book Design</a></h4>
                                                    <p>Design Book for your company</p>
                                                </td>
                                                <td class="product-price">$ 290.00</td>
                                                ...
                                                <td class="product-subtotal"><span>$ 290.00</span></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <h4><a href="shop-details.html">Invitation card Design</a></h4>
                                                    <p>Design Invitation card for your company</p>
                                                </td>
                                                <td class="product-price">$ 390.00</td>
                                                <td class="product-quantity">
                                                    <div class="cart-plus">
                                                        <form action="#">
                                                            <div class="cart-plus-minus">
                                                ...
                                                <td class="product-subtotal"><span>$ 390.00</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-8">
                                <aside class="shop-cart-sidebar">
                                    <div class="shop-cart-widget">
                                        ...
                                        <form action="#">
                                            <ul>
                                                <li><span>SUBTOTAL</span> $ 680.00</li>
                                                <li>
                                                    <span>SHIPPING</span>
                                                ...
                                                <li class="cart-total-amount"><span>TOTAL</span> <span class="amount">$ 665.00</span></li>
                                            </ul>
